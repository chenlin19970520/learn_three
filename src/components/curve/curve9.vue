...
const line1 = new THREE.LineCurve(new THREE.Vector2(-100, 100), new THREE.Vector2(-100, 0));//创建一条直线
const arc = new THREE.ArcCurve(0, 0, 100, 0, Math.PI, false);
const line2 = new THREE.LineCurve(new THREE.Vector2(100, 100), new THREE.Vector2(100, 0));//创建一条直线

const curvePath = new THREE.CurvePath();
curvePath.curves.push(line2, arc, line1);//拼接出一个U型轮廓

const points = curvePath.getPoints(50); // 获取曲线点坐标
