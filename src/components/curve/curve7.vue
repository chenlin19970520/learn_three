...
// const curve = new THREE.CubicBezierCurve(p1, p2, p3, p4);//创建三次贝塞尔曲线


const curve = new THREE.CubicBezierCurve3(p1, p2, p3, p4);//创建三维三次贝塞尔曲线

const points = curve.getPoints(50)
const geometry = new THREE.BufferGeometry().setFromPoints(points);

const pointGeometry = new THREE.BufferGeometry().setFromPoints([p1, p2, p3, p4]);
...
const pointMesh = new THREE.Line(pointGeometry, point)
scene.add(line);
scene.add(pointMesh)
