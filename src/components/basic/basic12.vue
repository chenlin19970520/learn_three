<template>
    <div id="basic" style="height: 100%;width: 100%;"></div>
</template>
...
onMounted(() => {
    document.getElementById("basic")?.appendChild(stats.dom);//将Stats添加到页面中
    document.getElementById("basic")?.appendChild(renderer.domElement);
})
</script>
